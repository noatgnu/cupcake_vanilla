...
from .serializers import LabGroupInvitationSerializer, LabGroupSerializer, SiteConfigSerializer

try:
    # Check if ORCID auth views are available
    from .view_modules import auth_views  # noqa: F401
...
class AdminManagementTestCase(TestCase):
    ...
    def test_site_config_admin_interface(self):
        ...
        from .admin import SiteConfigAdmin

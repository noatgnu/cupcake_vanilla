...
from .models import LabGroup, LabGroupInvitation, SiteConfig, UserOrcidProfile
        ...
        try:
            ...
            if site_config:
                ...
                data = {
                    ...
                    "show_powered_by": site_config.show_powered_by,
                    "allow_user_registration": site_config.allow_user_registration,
                    "enable_orcid_login": site_config.enable_orcid_login,
                }

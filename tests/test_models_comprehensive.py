...
class MetadataTableComprehensiveTest(TestCase, QuickTestDataMixin):
    ...
    def test_create_table_with_realistic_sdrf_data(self):
        ...
        self.assertEqual(proteomics_table.creator, self.user)
    ...
    def test_table_permissions_and_ownership(self):
        ...
        # Test ownership
        self.assertEqual(user1_table.creator, self.user)
        self.assertEqual(user2_table.creator, self.other_user)
        ...
        self.assertNotEqual(user2_duplicate.creator, user1_table.creator)
...
class SamplePoolComprehensiveTest(TestCase, QuickTestDataMixin):
    ...
    def test_pool_sdrf_value_generation(self):
        ...
        # Test that it contains pool information
        self.assertIn("Test Pool", sdrf_value)
    ...
    def test_species_model_with_realistic_data(self):
        ...
        with self.assertRaises(IntegrityError):
            with transaction.atomic():
                Species.objects.create(code="HUMAN", taxon=9999, official_name="Duplicate Human")  # Duplicate code

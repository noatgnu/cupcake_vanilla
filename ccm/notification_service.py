"""
CCM notification service for sending real-time notifications via WebSockets.

This module extends the base notification service for CCM-specific features
like instrument and maintenance log annotations with transcription.
"""
...
class CCMNotificationService:
    """Service for sending CCM-specific notifications via WebSockets."""

    def __init__(self):
        """Initialize the CCM notification service with the channel layer."""
    ...
    def _send_to_group(self, group_name: str, message_type: str, data: Dict[str, Any]):
        ...
        try:
            ...
            logger.debug(f"CCM notification sent to group {group_name}: {message_type}")
